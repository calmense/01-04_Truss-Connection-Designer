import { getTimberProperties, getTensileStrength } from './utilsMaterialProperties';  // Importing functions for material properties (assuming they are defined elsewhere)
